...
The original formulation of entropic gravity by Jacobson (1995) assumed an exact $S \propto R^2$ Bekenstein-Hawking area law. In TRXT, the pre-geometric Layer 0 is modeled as a \textbf{Random Tensor Network} where the entanglement entropy $S(\Omega)$ of a region $\Omega$ is precisely determined by the Ryu-Takayanagi minimal cut theorem: 
\begin{equation}
