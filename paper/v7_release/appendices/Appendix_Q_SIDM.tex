...
\begin{equation}
    r_0 = \frac{\hbar c}{M^*} \approx \frac{197.3 \text{ MeV \cdot fm}}{375.00 \text{ GeV}} \approx 5.4 \times 10^{-4} \text{ fm}
\end{equation}
...
\begin{equation}
    m_{128} = M^* \left( \frac{1}{128} + \frac{1}{128} \right) \approx \frac{375.00}{64} \approx 5.71 \text{ GeV}
\end{equation}
