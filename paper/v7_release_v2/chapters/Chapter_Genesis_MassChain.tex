...
\texttt{gap\_n4d\_relic\_20260814}):} Kibble--Zurek defect formation at the Great
Condensation overproduces the tower by $8$--$11$ orders, and geometric
soliton--antisoliton annihilation (solitons are extended, size $\sim 1/M^*$; thermal
...
GAP-N4d-asym). This sharpens the phenomenology: asymmetric dark matter predicts
...
candidate. (An earlier draft's ``unitarity-bound thermal relic'' phrasing is retracted:
