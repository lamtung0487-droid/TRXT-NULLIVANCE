...
\end{equation}
to a single $2\text{--}8\%$ discretization systematic. The $(p,q)$ labels of the earlier
...
follows the Seifert-exponential mechanism ($m_\tau/m_\mu=16.8$ predicted vs $16.81$ observed,
Appendix~Z'); gauge masses arise by the standard mechanism.
