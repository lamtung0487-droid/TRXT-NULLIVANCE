...
\end{equation}
This places the Layer~0 $\to$ Layer~1 transition at the GUT epoch, consistent with inflationary physics. For the full numerical derivation see \texttt{proof\_gate\_C\_time\_mapping.py} (Evidence ID: GATE-C-TIME-MAPPING-2026-03).
...
\end{equation}
where $b_2 = -19/6$, $b_3 = -7$ are the SM one-loop $\beta$-function coefficients. All inputs are PDG 2022 observables. Numerical verification: \texttt{proof\_gate\_C\_mcond\_derivation.py} (Evidence ID: GATE-C-MCOND-DERIVATION-2026-03, artifact: \texttt{artifacts/gate\_C\_mcond\_result.json}).
