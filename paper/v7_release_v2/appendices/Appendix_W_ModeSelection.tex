...
A topological defect with winding $p$ encodes $\log_2 p$ bits of information.  The Bekenstein bound~\cite{bekenstein1981} limits the information content of a Planck-size region, yielding $p_{\max} \sim e^{4\pi} \approx 2.7 \times 10^5$.  All modes with $p, q > p_{\max}$ are unphysical.
