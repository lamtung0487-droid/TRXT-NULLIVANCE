...
agreement cannot yet be claimed as a derivation (Anti-Hardcode Law). GAP-N4c remains open
at the \emph{justification} level: what would close it is (i) a reproducible lattice/DOS
computation distinguishing $50/(3\pi)$ from nearby values at the $0.1\%$ level, and
(ii) first-principles fixing of the prefactor, the cutoff, and $g=4$.
